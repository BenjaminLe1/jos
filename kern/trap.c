...
trap_init(void)
{
	...
	SETGATE(idt[IRQ_OFFSET + 0], 0, GD_KT, &th_irq_timer0, 0);
	SETGATE(idt[IRQ_OFFSET + 1], 0, GD_KT, &th_irq_timer1, 0);
	SETGATE(idt[IRQ_OFFSET + 2], 0, GD_KT, &th_irq_timer2, 0);
	SETGATE(idt[IRQ_OFFSET + 3], 0, GD_KT, &th_irq_timer3, 0);
	SETGATE(idt[IRQ_OFFSET + 4], 0, GD_KT, &th_irq_timer4, 0);
	SETGATE(idt[IRQ_OFFSET + 5], 0, GD_KT, &th_irq_timer5, 0);
	SETGATE(idt[IRQ_OFFSET + 6], 0, GD_KT, &th_irq_timer6, 0);
	SETGATE(idt[IRQ_OFFSET + 7], 0, GD_KT, &th_irq_timer7, 0);
	SETGATE(idt[IRQ_OFFSET + 8], 0, GD_KT, &th_irq_timer8, 0);
	SETGATE(idt[IRQ_OFFSET + 9], 0, GD_KT, &th_irq_timer9, 0);
	SETGATE(idt[IRQ_OFFSET + 10], 0, GD_KT, &th_irq_timer10, 0);
	SETGATE(idt[IRQ_OFFSET + 11], 0, GD_KT, &th_irq_timer11, 0);
	SETGATE(idt[IRQ_OFFSET + 12], 0, GD_KT, &th_irq_timer12, 0);
	SETGATE(idt[IRQ_OFFSET + 13], 0, GD_KT, &th_irq_timer13, 0);
	SETGATE(idt[IRQ_OFFSET + 14], 0, GD_KT, &th_irq_timer14, 0);
	SETGATE(idt[IRQ_OFFSET + 15], 0, GD_KT, &th_irq_timer15, 0);
